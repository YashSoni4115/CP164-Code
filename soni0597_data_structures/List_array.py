...
class List:
    ...
    def intersection(self, source1, source2):
        ...
        for value in source1:
            if value in source2 and value not in intersected:
                intersected.append(deepcopy(value))
        
        self._values = intersected 
    ...
    def __eq__(self, target):
        ...
        if len(self._values) == len(target._values):
            for a in range(len(self._values)):
                if self._values[a] == target._values[a]:
                    equals = True
                else:
                    equals = False
                    break
    ...
    def remove_front(self):
        ...
        for a in range(1, len(self._values)):
            self._values[a-1] = self._values[a]
        self._values.pop()
    ...
    def union(self, source1, source2):
        ...
        for value in source1._values:
            if value not in addition and value in source2:
                addition.append(value)
        
        self._values += addition
